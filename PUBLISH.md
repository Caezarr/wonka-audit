...
npm run pack:check
npm pack
npm_config_cache=/private/tmp/wonka-npx-cache npx --yes --package=./wonka-audit-0.3.2.tgz wonka-audit --metadata-only --out ./tmp/package-smoke
```
...
gh release create v0.3.2 --verify-tag --generate-notes
```
